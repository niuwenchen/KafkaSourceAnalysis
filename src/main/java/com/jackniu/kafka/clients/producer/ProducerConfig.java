...
import com.jackniu.kafka.clients.ClientDnsLookup;
import com.jackniu.kafka.clients.CommonClientConfigs;
import com.jackniu.kafka.clients.producer.internal.DefaultPartitioner;
import com.jackniu.kafka.common.config.AbstractConfig;
import com.jackniu.kafka.common.config.ConfigDef;
import com.jackniu.kafka.common.config.ConfigDef.Type;
import com.jackniu.kafka.common.config.ConfigDef.Importance;
import com.jackniu.kafka.common.metrics.Sensor;
import com.jackniu.kafka.common.serialization.Serializer;

import java.util.*;

import static com.jackniu.kafka.common.config.ConfigDef.Range.atLeast;
import static com.jackniu.kafka.common.config.ConfigDef.Range.between;
import static com.jackniu.kafka.common.config.ConfigDef.ValidString.in;
...
public class ProducerConfig extends AbstractConfig {
    ...
    static {
        System.out.println("执行这个Config函数");
        CONFIG = new ConfigDef()
                .define(BOOTSTRAP_SERVERS_CONFIG, ConfigDef.Type.LIST, Collections.emptyList(), new ConfigDef.NonNullValidator(), ConfigDef.Importance.HIGH, CommonClientConfigs.BOOTSTRAP_SERVERS_DOC)
                ...
                .define(BUFFER_MEMORY_CONFIG, Type.LONG, 32 * 1024 * 1024L, atLeast(0L), ConfigDef.Importance.HIGH, BUFFER_MEMORY_DOC)
                .define(RETRIES_CONFIG, Type.INT, Integer.MAX_VALUE, between(0, Integer.MAX_VALUE), ConfigDef.Importance.HIGH, RETRIES_DOC)
                .define(ACKS_CONFIG,
                        Type.STRING,
                        "1",
                        in("all", "-1", "0", "1"),
    ...
    public static Map<String, Object> addSerializerToConfig(Map<String, Object> configs,
        ...
        System.out.println("newConfigs:"+newConfigs);
        return newConfigs;
    }
