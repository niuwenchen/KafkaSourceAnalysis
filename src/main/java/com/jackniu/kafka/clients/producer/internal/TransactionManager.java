...
import com.jackniu.kafka.clients.ClientResponse;
import com.jackniu.kafka.clients.RequestCompletionHandler;
...
import com.jackniu.kafka.common.errors.GroupAuthorizationException;
import com.jackniu.kafka.common.errors.TopicAuthorizationException;
import com.jackniu.kafka.common.protocol.Errors;
import com.jackniu.kafka.common.record.DefaultRecordBatch;
...
public class TransactionManager  {
    ...
    private TxnOffsetCommitHandler txnOffsetCommitHandler(TransactionalRequestResult result,
        ...
        for (Map.Entry<TopicPartition, OffsetAndMetadata> entry : offsets.entrySet()) {
            ...
            TxnOffsetCommitRequest.CommittedOffset committedOffset = new TxnOffsetCommitRequest.CommittedOffset(offsetAndMetadata.offset(),
