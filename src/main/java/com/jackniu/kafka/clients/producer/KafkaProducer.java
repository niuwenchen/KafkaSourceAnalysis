...
import com.jackniu.kafka.clients.*;
import com.jackniu.kafka.clients.consumer.OffsetAndMetadata;
import com.jackniu.kafka.clients.producer.internal.*;
import com.jackniu.kafka.common.*;
import com.jackniu.kafka.common.config.ConfigException;
import com.jackniu.kafka.common.errors.*;
...
import com.jackniu.kafka.common.internals.ClusterResourceListeners;
import com.jackniu.kafka.common.metrics.*;
import com.jackniu.kafka.common.network.ChannelBuilder;
import com.jackniu.kafka.common.network.Selector;
import com.jackniu.kafka.common.record.AbstractRecords;
import com.jackniu.kafka.common.record.CompressionType;
import com.jackniu.kafka.common.record.RecordBatch;
import com.jackniu.kafka.common.serialization.Serializer;
import com.jackniu.kafka.common.utils.AppInfoParser;
import com.jackniu.kafka.common.utils.KafkaThread;
import com.jackniu.kafka.common.utils.LogContext;
 ...
 * their <code>ProducerRecord</code> into bytes. You can use the included  or
 * {@link } for simple string or byte types.
 * <p>
...
public class KafkaProducer<K, V> implements Producer<K, V> {
    ...
    KafkaProducer(Map<String, Object> configs,
        ...
        try {
            ...
            System.out.println("userProvidedConfigs " +userProvidedConfigs);
            ...
            System.out.println("metricTags"+ metricTags);
    ...
    private Future<RecordMetadata> doSend(ProducerRecord<K, V> record, Callback callback) {
        ...
        try {
            ...
            System.out.println("执行发送消息的任务"+ record.topic() +"  "+ record.partition());
            try {
            ...
            System.out.println("Sending record "+ record + " with callback "+ callback +" to topic "+  record.topic()+" partition "+ partition);
