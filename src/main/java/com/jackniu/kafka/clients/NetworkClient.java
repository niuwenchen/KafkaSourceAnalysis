...
import com.jackniu.kafka.common.errors.DisconnectException;
import com.jackniu.kafka.common.errors.UnsupportedVersionException;
import com.jackniu.kafka.common.metrics.Sensor;
import com.jackniu.kafka.common.network.ChannelState;
import com.jackniu.kafka.common.network.NetworkReceive;
import com.jackniu.kafka.common.network.Selectable;
import com.jackniu.kafka.common.network.Send;
import com.jackniu.kafka.common.protocol.ApiKeys;
import com.jackniu.kafka.common.protocol.CommonFields;
import com.jackniu.kafka.common.protocol.Errors;
import com.jackniu.kafka.common.protocol.types.Struct;
import com.jackniu.kafka.common.requests.*;
...
public class NetworkClient implements KafkaClient {
     ...
     * usually transient and can be resumed in the next {@link } }
    ...
    public List<ClientResponse> poll(long timeout, long now) {
        ...
        System.out.println("执行NetworkClient A");
        ensureActive();
        ...
        completeResponses(responses);
        System.out.println("执行NetworkClient B: "+ responses);
        return responses;
    }
    ...
    private void handleConnections() {
        for (String node : this.selector.connected()) {
            ...
            if (discoverBrokerVersions) {
                ...
                log.info("Completed connection to node {}. Fetching API versions.", node);
            } else {
                this.connectionStates.ready(node);
