...
public final class Utils {
    ...
    public static String utf8(ByteBuffer buffer, int length){return utf8(buffer,0,length);}
    ...
    public static short min(short first,short second){return (short) Math.min(first,second);}
