...
import com.jackniu.kafka.common.errors.InvalidConfigurationException;
import com.jackniu.kafka.common.security.JaasContext;
import com.jackniu.kafka.common.security.auth.DefaultPrincipalBuilder;
import com.jackniu.kafka.common.security.auth.KafkaPrincipalBuilder;
import com.jackniu.kafka.common.security.auth.PrincipalBuilder;
...
import com.jackniu.kafka.common.security.authenticator.DefaultKafkaPrincipalBuilder;
...
public class ChannelBuilders {
    ...
    private static PrincipalBuilder createPrincipalBuilder(
    ...
    public static KafkaPrincipalBuilder createPrincipalBuilder(Map<String, ?> configs,
        ...
        if (principalBuilderClass == null || principalBuilderClass == DefaultKafkaPrincipalBuilder.class) {
            ...
            throw new InvalidConfigurationException("Type " + principalBuilderClass.getName() + " is not " +
                    "an instance of " + PrincipalBuilder.class.getName() + " or " +
