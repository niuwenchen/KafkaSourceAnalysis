...
import com.jackniu.kafka.clients.NetworkClient;
...
import com.jackniu.kafka.common.errors.SaslAuthenticationException;
import com.jackniu.kafka.common.errors.UnsupportedSaslMechanismException;
import com.jackniu.kafka.common.network.*;
import com.jackniu.kafka.common.protocol.ApiKeys;
import com.jackniu.kafka.common.protocol.Errors;
import com.jackniu.kafka.common.protocol.types.SchemaException;
...
import com.jackniu.kafka.common.security.kerberos.KerberosError;
...
public class SaslClientAuthenticator implements Authenticator {
     ...
     * {@value }; after that the flow joins the authentication flow
