...
public class FileRecords extends AbstractRecords implements Closeable {
    ...
    public LogOffsetPosition searchForOffsetWithSize(long targetOffset, int startingPosition) {
        for (FileLogInputStream.FileChannelRecordBatch batch : batchesFrom(startingPosition)) {
     ...
     */
    public Iterable<FileLogInputStream.FileChannelRecordBatch> batchesFrom(final int start) {
