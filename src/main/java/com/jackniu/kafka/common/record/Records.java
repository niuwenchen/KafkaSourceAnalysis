 ...
 *
 * See {@link MemoryRecords} for the in-memory representation and {@link } for the on-disk representation.
 */
...
public interface Records extends BaseRecords {
     ...
     * assignment (see for example {@link }), and partial reading of
     * record data (see {@link
     * @return An iterator over the record batches of the log
     */
    Iterable<? extends RecordBatch> batches();

    /**
     * Get an iterator over the record batches. This is similar to {@link #batches()} but returns an {@link }
     * instead of {@link Iterator}, so that clients can use methods like {@link #() peek}.
     * @return An iterator over the record batches of the log
     */
     ...
     *                    {@link #(Iterable, byte, long, )} for an explanation.
